...
import java.util.Optional;
    ...
    public class JobService {
        ...
        private static final Logger log = LoggerFactory.getLogger(com.techne.ChronoFlow.application.job.JobService.class);
        ...
        @Transactional(readOnly = true)
        public Optional<List<ArquivoRetorno>> getArquivosByJobId(Long id) {
            return jobRepository.findById(id).map(Job::getArquivos);
        }
